...
/**
 * REST controller for managing {@link com.school.domain.Attendance}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AttendanceResource {
    ...
    public List<Attendance> getAllAttendances(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Attendances");
        if (eagerload) {
            return attendanceRepository.findAllWithEagerRelationships();
        } else {
    ...
    public ResponseEntity<Attendance> getAttendance(@PathVariable Long id) {
        ...
        Optional<Attendance> attendance = attendanceRepository.findOneWithEagerRelationships(id);
