...
import com.school.domain.Notification;
...
class NotificationResourceIT {
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.subject(UPDATED_SUBJECT).description(UPDATED_DESCRIPTION).notificationDate(UPDATED_NOTIFICATION_DATE);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.notificationDate(UPDATED_NOTIFICATION_DATE);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.subject(UPDATED_SUBJECT).description(UPDATED_DESCRIPTION).notificationDate(UPDATED_NOTIFICATION_DATE);
