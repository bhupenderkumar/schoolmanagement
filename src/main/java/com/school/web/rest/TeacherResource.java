...
/**
 * REST controller for managing {@link com.school.domain.Teacher}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Teacher> partialUpdateTeacher(
        ...
        Optional<Teacher> result = teacherRepository
            ...
            .map(existingTeacher -> {
                ...
                if (teacher.getIdProof() != null) {
                    existingTeacher.setIdProof(teacher.getIdProof());
                }
                if (teacher.getIdProofContentType() != null) {
                    existingTeacher.setIdProofContentType(teacher.getIdProofContentType());
                }
                if (teacher.getPhoneNumber() != null) {
                    existingTeacher.setPhoneNumber(teacher.getPhoneNumber());
                }
                if (teacher.getEmergencyContactNumber() != null) {
                    existingTeacher.setEmergencyContactNumber(teacher.getEmergencyContactNumber());
                }
