...
import { ParentService, RestParent } from './parent.service';

const requireRestSample: RestParent = {
  ...sampleWithRequiredData,
  accountStartingDate: sampleWithRequiredData.accountStartingDate?.format(DATE_FORMAT),
};
